  ...
  return (
    <Box className="container mx-auto mt-4">
      ...
      >
        ...
        <InputGroup size="lg" className="bg-white sm:basis-[35%]" rounded={10}>
          <InputLeftElement
            pointerEvents="none"
            children={
              <MyIcon
                href="/sprite.svg#search"
        ...
        <InputGroup rounded={10} size="lg" className="bg-white sm:basis-[35%]">
          <InputLeftElement
            pointerEvents="none"
            children={
              <MyIcon
      ...
      <Box as="section" className="relative mt-8">
        ...
        {isLargeThan640 ? (
          ...
          <Box className="grid grid-cols-8 gap-6">
            <Box
              as="ul"
              className="col-span-3 h-full max-h-[800px] overflow-auto grid gap-4"
            >
              {renderedData.length > 0 ? (
                renderedData.map((job, idx) => (
                  <Box
                    key={idx}
                    as="li"
                    className="h-min p-2 bg-white ring-1 ring-gray-300  rounded-md sm:col-span-3"
                  >
            ...
            <Box className="col-span-5 min-h-96">
              {match ? (
                ...
                <MyIcon href="/sprite.svg#join-us" className="w-full h-full" />
              )}
            </Box>
          </Box>
        ) : (
              ...
              match ? (
                ...
                renderedData.map((job, idx) => (
                  <Box
                    key={idx}
                    as="li"
                    className="p-2 bg-white ring-1 ring-gray-300  rounded-md sm:col-span-3"
                  >
                    <Box className="space-y-2">
                      <Heading as="h6" size="md" className="capitalize">
                        {job.job_title}
